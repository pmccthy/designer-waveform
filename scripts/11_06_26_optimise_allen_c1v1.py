#!/usr/bin/env python3
"""
Optimise AsymBaselineSplitGaussianWaveform to match Allen VISp PSTH — C1V1-A opsin.
...
# ── CONFIG ───────────────────────────────────────────────────────────────────
OPSIN          = 'c1v1'
MAX_IRR_MW_MM2 = 0.1    # irradiance at ~saturation for this opsin (mW/mm²)
...
_amp_init  = MAX_POWER_MW * 0.06
_base_max  = MAX_POWER_MW * 0.06
